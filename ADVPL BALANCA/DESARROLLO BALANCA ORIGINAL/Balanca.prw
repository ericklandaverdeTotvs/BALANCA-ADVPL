...
±±ºPrograma  ³Balanca   º Autor ³ LUIS LACOMBE       º Data ³  01/07/2014 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescri‡„o ³Faz a requisicao do peso pela porta serial.                 º±±
±±º          ³                                                            º±±
...
oDlg1      := MSDialog():New( 091,232,392,965,"Balança",,,.F.,,,,,,.T.,,,.T. )
